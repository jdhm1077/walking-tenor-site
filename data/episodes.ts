...
export const episodes: Episode[] = [
  ...
  },
  {
    slug: "episode-5",
    num: "05",
    title: "Episode 5: Why Boleros Make You Cry",
    teaser: "Boleros don’t just make us sad. They awaken memory, give sorrow a melody, and somehow leave us feeling a little less alone.",
    synopsis: "Boleros don’t just make us sad. They awaken memory, give sorrow a melody, and somehow leave us feeling a little less alone.",
    synopsisParagraphs: [
      "The Psychology of a Sweet Ache",
      "Why do we willingly listen to songs that we know might make us cry?",
      "In this episode of The Walking Tenor Podcast, Jesús Daniel Hernández explores the strange emotional power of the bolero—music that can turn a melody into a memory and an ordinary room into a place filled with people, places, loves, and losses we thought we had left behind.",
      "From its unhurried pulse and unresolved longing to the expressive weight of the Spanish language, the bolero has a remarkable way of giving sorrow a shape. A guitar begins, a voice holds a note just a little longer, and suddenly the past has keys to the house.",
      "But perhaps we don’t listen to boleros because we want to suffer.",
      "Perhaps we listen because they remind us that someone else has felt it too.",
      "A bolero can take something private—a love lost, a goodbye, a memory that still hurts—and make it communal. It doesn’t promise to fix what happened. It simply gives the feeling somewhere to sit.",
      "Because boleros don’t break your heart.",
      "They finish the sentence your heart started.",
      "And the tears?",
